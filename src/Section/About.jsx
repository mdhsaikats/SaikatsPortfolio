  ...
  return (
    ...
    >
      ...
      <div className="flex-[1.2] text-center lg:text-left">
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 md:mb-8 text-center lg:text-left">
          About <span className="font-normal">Me</span>
        </h2>
        <div className="flex flex-col gap-6 text-left sm:text-center lg:text-left">
          <p className="text-gray-600 text-base md:text-[1.125rem] leading-relaxed">
